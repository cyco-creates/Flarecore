...
MOTION_TARGETS = {
    ...
    'coma': dict(label='Pupil shear', min=-1., max=1., neutral=0., mode='param', types=['iris','spectral']),
    'caustic': dict(label='Caustic fold', min=0., max=1., neutral=0., mode='param', types=['iris','spectral']),
    'completion': dict(label='Visible arc (degrees)', min=0., max=360., neutral=360., mode='param', types=['ring','hoop','glint','spectral']),
