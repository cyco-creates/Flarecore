...
STARTERS = [
    ...
    ("shimmers/spark_12", {"type": "glint", "scale": 0.9, "color": [1.0, 0.95, 0.8],
                           "params": {"points": 12, "length": 0.8,
                                      "thickness": 0.01, "length_jitter": 0.35}}),
    ("shimmers/fine_burst", {"type": "glint", "scale": 0.95, "intensity": 0.8,
                             "color": [0.85, 0.9, 1.0],
                             "params": {"points": 24, "length": 0.9,
                                        "thickness": 0.005, "length_jitter": 0.5}}),
    ("iris_ghosts/hex_soft", {"type": "iris", "scale": 0.6, "intensity": 0.85,
                              "color": [0.6, 0.8, 1.0],
                              "params": {"blades": 6, "edge_softness": 0.35}}),
    ("iris_ghosts/octa_hollow", {"type": "iris", "scale": 0.62, "intensity": 0.9,
    ...
    ("spectral/rainbow_ring", {"type": "spectral", "scale": 0.58,
                               "dispersion": 2.2, "dispersion_samples": 9,
                               "params": {"shape": "ring", "radius": 1.0,
                                          "thickness": 0.07}}),
    ("dirt_bokeh/hex_cluster", {"type": "iris", "scale": 0.16, "intensity": 0.5,
